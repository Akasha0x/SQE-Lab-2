...
# ── Updated Ratings (Based on Report Analysis) ────────────────
# Google Maps stronger overall
# Apple Maps better in usability/design but lower in features

APP1_RATINGS = [5, 5, 5, 4, 5, 4, 4, 5]   # Google Maps
APP2_RATINGS = [4, 4, 4, 5, 4, 5, 3, 4]   # Apple Maps
...
print(f"{'Characteristic':<30}{APP1_NAME:>14}{APP2_NAME:>14}{'Weight':>10}")
print("-" * 65)

for char, r1, r2, w in zip(CHARACTERISTICS, APP1_RATINGS, APP2_RATINGS, WEIGHTS):
    label = char.replace("\n", " ")
    print(f"{label:<30}{r1:>14}{r2:>14}{w:>9.0%}")

print("-" * 65)
print(f"{'WEIGHTED TOTAL':<30}{app1_score:>14.2f}{app2_score:>14.2f}")
print("=" * 65)
...
# ── Added Recommendations from Report ─────────────────────────
print("\nRecommendations:")
print("\nFor Google Maps:")
print("1. Simplify interface design")
print("2. Improve privacy settings")
print("3. Reduce battery usage")
print("4. Better menu organization")

print("\nFor Apple Maps:")
print("1. Improve route accuracy")
print("2. Add offline maps support")
print("3. Increase business listings")
print("4. Improve transport routes")
